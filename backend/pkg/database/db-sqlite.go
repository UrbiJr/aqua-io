...
func (repo *SQLiteRepository) InsertProfile(p user2.Profile) (*user2.Profile, error) {
...
func (repo *SQLiteRepository) InsertOpenedPosition(p user2.OpenedPosition) (*user2.OpenedPosition, error) {
...
func (repo *SQLiteRepository) InsertUser(u user2.User) (*user2.User, error) {
...
func (repo *SQLiteRepository) AllProfiles() ([]user2.Profile, error) {
...
func (repo *SQLiteRepository) AllOpenedPositions() ([]user2.OpenedPosition, error) {
	...
	var all []user2.OpenedPosition
	for rows.Next() {
		var p user2.OpenedPosition
...
func (repo *SQLiteRepository) GetUser(ID int64) (*user2.User, error) {
...
func (repo *SQLiteRepository) GetAllUsers() (*user2.User, error) {
...
func (repo *SQLiteRepository) UpdateProfile(id int64, updated user2.Profile) error {
	if id <= 0 {
...
func (repo *SQLiteRepository) UpdateOpenedPosition(orderId string, updated user2.OpenedPosition) error {
	if orderId == "" {
		return errors.New("invalid updated id")
	}
...
func (repo *SQLiteRepository) UpdateUser(id int64, updated user2.User) error {
	if id <= 0 {
		return errors.New("invalid updated id")
	}
